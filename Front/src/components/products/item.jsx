...
const Item = ( prop ) => {
    ...
    const handleDelete = async (idProduct) => {
        ...
        try {
            const response = await axios.delete(`/products/${idProduct}`)
                    ...
                    <div className=" h-full mx-auto px-6 md:px-0 rounded-lg md:pt-6 md:-ml-2 relative">
                        <div className="bg-white p-6 rounded-lg shadow-slate-800 shadow-lg mr-2">
                            ...
                            <div className="p-4 border-t border-b border-sky-900 text-xs text-gray-700">
                                ...
                                <button type="button" className="bg-red-500 hover:bg-red-400 border-b-4 border-red-700 hover:border-red-500 text-white text-center font-bold py-2 px-4 rounded" onClick={()=> handleDelete(prop.idProduct)} >
